...
text_input.append(1.0 if st.text_input("Введите пол?", "Нужно ввести Мужчина или Женщина").lower() == 'мужчина' else 0.0)
text_input.append(1.0 if st.text_input("Состоите в браке?", "Нужно ввести Да или Нет").lower() == 'мужчина' else 0.0)
text_input.append(1.0 if st.text_input("Сколько у Вас детей?", "Нужно ввести количестов").lower() == 'мужчина' else 0.0)
text_input.append(1.0 if st.text_input("Есть ли у вас высшее образование?", "Нужно ввести Да или Нет").lower() == 'мужчина' else 0.0)
