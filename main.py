...
a = float(st.text_input("Какой у Вас месячный доход в рублях?", "Нужно ввести количестов")) * 12 / 91.26
text_input.append(a)

a = float(st.text_input("Какой у Вашего созаявителя месячный доход в рублях?", "Нужно ввести количестов")) * 12 / 91.26
text_input.append(a)

a = st.text_input("На сколько дней хотели бы взять займ?", "Нужно ввести количестов")
text_input.append(a)
